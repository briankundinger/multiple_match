...
saveRDS(fl_out, "out/ncvr_results/chain/fastlink_jaro")
saveRDS(Z_hat, "out/ncvr_results/Z_hat/fastlink_jaro")
saveRDS(fl_out$posterior, "out/ncvr_results/prob/fastlink_jaro")
...
df <- data.frame(n1 = n1,
                 ...
                 data = "ncvr")
saveRDS(df, "out/ncvr_results/eval/fastlink_jaro")

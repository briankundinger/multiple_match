...
saveRDS(out, "out/ncvr_results/chain/variational_fastlink")
...
saveRDS(fs_df[, 1:2], "out/ncvr_results/Z_hat/variational_fastlink")
saveRDS(fs_df[, 3], "out/ncvr_results/prob/variational_fastlink")
...
df <- data.frame(n1 = n1,
                 ...
                 data = "ncvr")
saveRDS(df, "out/ncvr_results/eval/variational_fastlink")
